...
![Add a new project in PyCharm - Step 4](https://apidocs.io/illustration/python?step=projectFiles&workspaceFolder=Telstra%20Messaging%20API-Python&libraryName=telstramessagingapi.telstramessagingapi_client&projectName=telstramessagingapi&className=TelstramessagingapiClient)
...
![Run Test Project - Step 1](https://apidocs.io/illustration/python?step=runProject&workspaceFolder=Telstra%20Messaging%20API-Python&libraryName=telstramessagingapi.telstramessagingapi_client&projectName=telstramessagingapi&className=TelstramessagingapiClient)
...
provisioning_controller.delete_subscription()
